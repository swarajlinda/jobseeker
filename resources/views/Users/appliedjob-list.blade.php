                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td>
                                @if($job->accept_reject==1)
                                <span class="badge bg-danger">Approved</span>
                                @elseif($job->accept_reject==0)
                                <span class="badge bg-warning text-dark">Pending</span>
                                @else
                                <span class="badge bg-info text-dark">Rejected</span>
                                @endif

                                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.replace('users/applied-job-details/{{$job->id}}')">
